...
const rightHandDots = [
  { index: 1, top: "10%", left: "50%" }, // thumb (bottom right)
  { index: 2, top: "35%", left: "10%" }, // index
  { index: 3, top: "58%", left: "5%" }, // middle
  { index: 4, top: "75%", left: "12%" }, // ring
  { index: 5, top: "90%", left: "18%" }, // little (top left)
];
...
{/* 
          {
            capturedFingerprint && (
              <div style={{ marginBottom: "20px", padding: "16px", background: "#f7fafc", borderRadius: 12, border: "1px solid #e2e8f0", fontSize: "12px", color: "#4a5568", maxHeight: "100px", overflowY: "auto" }}>
                ...
                <div style={{ marginTop: "8px", wordBreak: "break-all" }}>{capturedFingerprint || "No data captured yet."}</div> 
              </div>    
            )
          } */}
